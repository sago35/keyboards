...
func run() error {
	...
	sm := d.AddSquaredMatrixKeyboard(colPins, [][]keyboard.Keycode{
		{
			...
			jp.KeyEsc, jp.KeyWindows, jp.KeyLeftAlt, jp.KeyMod1, jp.KeySpace, jp.KeySpace, jp.KeySpace, jp.KeyMod2, jp.KeyHankaku, 0, jp.KeyPrintscreen, jp.KeyDelete,
		},
		{
			...
			jp.KeyEsc, jp.KeyWindows, jp.KeyLeftAlt, jp.KeyMod1, jp.KeySpace, jp.KeySpace, jp.KeySpace, jp.KeyMod2, jp.KeyHankaku, jp.KeyTo2, jp.KeyPrintscreen, jp.KeyDelete,
		},
		{
	...
	combos := []keyboard.Combo{
		...
		{
			Keys:      [4]keyboard.Keycode{jp.KeyQ, jp.KeyX},
			OutputKey: jp.KeyMediaVolumeDec,
		},
		{
			Keys:      [4]keyboard.Keycode{jp.KeyQ, jp.KeyC},
