smoketest: FORCE
	...
	tinygo build -o ./out/zero-kb02.uf2        --target waveshare-rp2040-zero --size short --tags zero_kb02                    ./zero-kb02/firmware/
	tinygo build -o ./out/zero-kb02-invert.uf2 --target waveshare-rp2040-zero --size short --tags zero_kb02,invert_rotary_pins ./zero-kb02/firmware/
