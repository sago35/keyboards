...
抵抗以外も含め、必要に応じてケースに干渉しない程度にカットしてください。  
...
ピンヘッダーの足は短くカットする必要があります。  
割と硬いためスタッフにて切断します。  
スタッフに声をかけてください。  
自分でする場合は、切断した破片が飛んでいかないように手で押さえつつカットしてください。  
...
基板に印刷された△のマークと、 LED の足の切り欠きを合わせる必要があります。  
方向の間違いが多いため、はんだ付け前後いずれかでスタッフを呼んで確認してもらってください。  
